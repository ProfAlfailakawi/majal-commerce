  ...
  return (
    <div className="bg-slate-900/90 rounded-2xl border border-slate-800 p-6 space-y-6 text-slate-100">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
        <div>
          <label className="block text-slate-300 font-bold mb-1">سعر البيع الافتراضي للجمهور (د.ك):</label>
          <input
            type="number"
            step="0.25"
            min="0.25"
        ...
        <div>
          <label className="block text-slate-300 font-bold mb-1">نسبة حقوق المبدع (٪):</label>
          <input
            type="number"
            step="0.5"
            min="0"
        ...
        <div>
          <label className="block text-slate-300 font-bold mb-1">مدة العقد الحصري (أشهر):</label>
          <input
            type="number"
            min="1"
            max="60"
        ...
        <div>
          <label className="block text-slate-300 font-bold mb-1">الحد الأدنى الملتزم به (قطعة):</label>
          <input
            type="number"
            min="0"
            value={minUnits}
      ...
      <div>
        <label className="block text-slate-300 font-bold mb-1 text-xs">ملاحظات وشروط إضافية للعرض:</label>
        <textarea
          rows={2}
          value={notes}
