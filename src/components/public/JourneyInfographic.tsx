...
export const JourneyInfographic: React.FC = () => (
  <section aria-labelledby="journey-heading" className="space-y-10">
    <div className="text-center space-y-3">
      <span className="inline-block text-xs font-black tracking-[0.25em] text-gold-300 uppercase">رحلة مجال</span>
        ...
        >
          <div className="flex items-center justify-between gap-3">
            ...
            <span className="flex items-center gap-2">
              ...
              <span className="text-xs font-bold text-slate-400">{stage.actor}</span>
            </span>
          </div>
