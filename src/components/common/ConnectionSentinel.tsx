...
export const ConnectionSentinel: React.FC = () => {
  ...
  return <div role="status" aria-live="polite" className="fixed bottom-5 left-5 z-[94] w-[min(360px,calc(100vw-2.5rem))] rounded-2xl bg-ink-600/98 border border-amber-400/25 shadow-2xl p-4 flex items-start gap-3">
