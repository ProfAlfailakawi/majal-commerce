...
const lockupScale = {
  sm: { mark: 32, word: 'text-lg', tagline: 'text-xs', gap: 'gap-2.5' },
  md: { mark: 42, word: 'text-2xl', tagline: 'text-xs', gap: 'gap-3' },
  ...
  return (
    <span className={`flex items-center ${scale.gap} ${className}`}>
      ...
      <span className="min-w-0 text-start">
        ...
        {showLatin && (
          <span className="block text-xs font-semibold tracking-[0.42em] text-gold-500/70 leading-none mt-1" dir="ltr">
            MAJAL
          </span>
        )}
